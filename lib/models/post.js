...
/*---------------------------------------------------------------------
 ...
 --------------------------------------------------------------------*/
  var postSchema = new Schema({
      ...
      tags:         {type: Array, es_indexed:true, index:true}
  });

  postSchema.plugin(mongoosastic, {host:elasticConnection.hostname, auth: elasticConnection.auth, port: '', protocol: elasticConnection.protocol === 'https:' ? 'http' : 'https'});
